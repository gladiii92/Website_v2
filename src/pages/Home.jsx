    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: 'linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.3)), url("/images/banner.jpg")',
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to={createPageUrl("Collection")}>
              <Button className="primary-btn hover:bg-blue-600 text-white px-8 py-4 text-lg font-semibold rounded-none transition-all duration-300 transform hover:scale-105 flex items-center">
                {t.view_collection}
      ...
      <section className="py-24 bg-primary-dark text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <Link to={createPageUrl("Contact")}>
            <Button className="cta-btn hover:bg-orange-600 text-white px-8 py-4 text-lg font-semibold rounded-none transition-all duration-300 flex items-center">
              {t.cta_consultation}
              <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
          </Link>
