...
const translations = {
  de: {
    ...
    global_desc: "Direkter Zugang zu ausgewählten Minen und Quellen in den bedeutendsten Edelsteinregionen der Welt",
  ...
  fr: {
    ...
    global_desc: "Accès direct à des mines et sources sélectionnées dans les régions gemmologiques les plus importantes du monde",
                ...
                <Carousel showThumbs={false} infiniteLoop={true} autoPlay={true} interval={3000}>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Zertifizierung für Spinell-Edelsteine.
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Zertifizierung für Aquamarin-Edelsteine.
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Zertifizierung für Smaragd-Edelsteine.
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Zertifizierung für Granat-Edelsteine.
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Zertifizierung für Rubin-Edelsteine.
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Zertifizierung für Saphir-Edelsteine.
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Zertifizierung für Topaz-Edelsteine.
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Zertifizierung für Tourmalin-Edelsteine.
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Zertifizierung für Zircon-Edelsteine.
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                      Zertifizierung für Citrin-Edelsteine.
                    </p>
                  </div>
