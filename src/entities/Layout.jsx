          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="flex items-center justify-between h-20">
              <Link to={createPageUrl("Home")} className="flex items-center">
                <div className="serif-heading text-2xl lg:text-3xl font-bold text-gray-900 tracking-tight">
                  {t.company_name}
                  <span className="text-sm font-light text-gray-500 ml-2">Premium Gemstones</span>
                </div>
              </Link>
        ...
        <footer className="bg-primary-dark text-pearl-white mt-32">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
            <div className="grid md:grid-cols-4 gap-12">
              ...
              <div>
                ...
                <div className="space-y-3 text-gray-200">
                  ...
                  <div>
                    <div className="text-sm">NobleCutGems GmbH</div>
                    <div className="text-sm">Maximilianstraße 15</div>
                    <div className="text-sm">80539 München, Deutschland</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm text-gray-500">
              <p>© 2024 {t.company_name}. {language === 'de' ? 'Alle Rechte vorbehalten' : language === 'fr' ? 'Tous droits réservés' : 'All rights reserved'}. | {language === 'de' ? 'Datenschutz' : language === 'fr' ? 'Confidentialité' : 'Privacy'} | {language === 'de' ? 'Impressum' : language === 'fr' ? 'Mentions légales' : 'Legal Notice'} | {language === 'de' ? 'AGB' : language === 'fr' ? 'CGV' : 'Terms'}</p>
            </div>
          </div>
        </footer>
      </div>
